...
```bash
pip install jupyterlab-ascii-homer
```
...
```bash
pip uninstall jupyterlab-ascii-homer
```
...
# Change directory to the jupyterlab-ascii-homer directory
...
folder is located. Then you can remove the symlink named `jupyterlab-ascii-homer` within that folder.
